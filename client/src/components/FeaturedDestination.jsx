  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20 '>
      <Title title='Featured Destination' subTitle='Discover our handpicked selection of exceptional properties around the world, offering unparalleled luxury and unforgettable experience.  ' />
        ...
        <button onClick={()=>{navigate('/rooms'); scrollTo(0,0)}} className='bg-white hover:bg-gray-50 cursor-pointer my-16 px-4 py-2 text-sm font-medium border border-gray-300 rounded transition-all'>View All Destinations</button>
    </div>
  )
}
